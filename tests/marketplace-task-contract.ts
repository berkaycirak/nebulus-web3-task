...
import { MarketplaceTaskContract } from '../target/types/marketplace_task_contract';
import {
	createNft,
...
describe('marketplace', () => {
	...
	const program = anchor.workspace.MarketplaceTaskContract as Program<MarketplaceTaskContract>;
	...
	const name = 'your_marketplace_name';
